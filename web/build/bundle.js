...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/qzw/workspace/lab/chatroom/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/qzw/workspace/lab/chatroom/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var App = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        for (var x in this.state.onlineUsers) {
	            ...
	            var ins = _react2['default'].createElement('div', { key: x, className: 'user' }, _react2['default'].createElement('span', { className: 'avatar' }, a), _react2['default'].createElement('span', { className: 'name' }, user.username), _react2['default'].createElement('span', { className: 'time' }, t, ' 加入'));
	            onlines.push(ins);
	        }
	        var messages = [];
	        for (var x in this.state.messages) {
	            ...
	            var ins = _react2['default'].createElement('div', { className: "message" + (message.userid == this.state.userid ? " self" : ""), key: x }, _react2['default'].createElement('div', { className: 'avatar' }, a), _react2['default'].createElement('div', { className: 'info' }, _react2['default'].createElement('span', { className: 'name' }, message.username), _react2['default'].createElement('span', { className: 'time' }, ' ', t)), _react2['default'].createElement('div', { className: 'content' }, message.content));
	            messages.push(ins);
	        }
	        return _react2['default'].createElement('div', { className: 'full' }, _react2['default'].createElement('div', { className: "sidebar ease" + (this.state.toggle ? " toggle" : ""), ref: 'sidebar' }, _react2['default'].createElement('div', { className: 'head' }, _react2['default'].createElement('div', { className: 'avatar ease' }, ava), _react2['default'].createElement('div', { className: 'username ease' }, this.state.username), _react2['default'].createElement('input', { style: { display: this.state.isLogin != true ? "inline" : "none" }, placeholder: '输入一个名字', ref: 'username' }), _react2['default'].createElement('span', { style: { display: this.state.isLogin != true ? "inline" : "none" }, onClick: this.login }, '登录')), _react2['default'].createElement('div', { className: 'online-users ease', style: { top: this.state.isLogin != true ? "130px" : "100px" } }, onlines)), _react2['default'].createElement('div', { className: "container ease" + (this.state.toggle ? " toggle" : ""), id: 'container' }, _react2['default'].createElement('div', { className: 'title' }, _react2['default'].createElement('i', { className: 'fa fa-bars', id: 'toggle', onClick: this.toggle }), 'Chatroom'), _react2['default'].createElement('div', { className: "messages ease" + (this.state.typing ? " typing" : ""), ref: 'content' }, messages), _react2['default'].createElement('div', { className: 'send', ref: 'sendContainer' }, _react2['default'].createElement('textarea', { className: 'ease', ref: 'message', type: 'text', placeholder: 'Enter发送消息' }), _react2['default'].createElement('button', { ref: 'send', onClick: this.send }, '发  送'))));
	    }
	});

	_reactDom2['default'].render(_react2['default'].createElement(App, null), document.getElementById("chat"));

	exports['default'] = App;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/qzw/workspace/lab/chatroom/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
